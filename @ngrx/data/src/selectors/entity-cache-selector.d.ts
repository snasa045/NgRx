...
export declare const ENTITY_CACHE_SELECTOR_TOKEN: InjectionToken<MemoizedSelector<Object, EntityCache, import("@ngrx/store/src/selector").DefaultProjectorFn<EntityCache>>>;
